###################################################################
#                                                                 #
#                CELLORACLE STEP 7: IN SILICO KO                  #
#                                                                 #
###################################################################
...
n_propagation = 3
file_path = "/home/iriverog/NetVolumes/LAB_MT/RESULTADOS/Ines/Axolotl_Limb_Regeneration/Results/celloracle/BLct_CSDct_TF_candidates_KO.celloracle.hdf5"
ps_file = "/home/iriverog/NetVolumes/LAB_MT/RESULTADOS/Ines/Axolotl_Limb_Regeneration/Results/celloracle/BLct_CSDct_TF_candidates_KO_Result.tsv"
...
def pipeline(gene_for_KO):
    print("Simulating KO")
    # 1. Simulate KO
    oracle.simulate_shift(perturb_condition={gene_for_KO: 0}, ignore_warning=True, n_propagation=n_propagation)
    ...
    for lineage_name, cell_idx in index_dictionary.items():
        ...
        PSgrid = "/home/iriverog/NetVolumes/LAB_MT/RESULTADOS/Ines/Axolotl_Limb_Regeneration/Results/celloracle/BLct_CSDct_KO_" + lineage_name + "_" + gene_for_KO + "_PSgrid.pdf"
        PSgridvector = "/home/iriverog/NetVolumes/LAB_MT/RESULTADOS/Ines/Axolotl_Limb_Regeneration/Results/celloracle/BLct_CSDct_KO_" + lineage_name + "_" + gene_for_KO + "_PSvector.pdf"
        vectorfieldsplot = "/home/iriverog/NetVolumes/LAB_MT/RESULTADOS/Ines/Axolotl_Limb_Regeneration/Results/celloracle/BLct_CSDct_KO_" + gene_for_KO + "VectorsFieldPlot.pdf"
        vectorwithcluster = "/home/iriverog/NetVolumes/LAB_MT/RESULTADOS/Ines/Axolotl_Limb_Regeneration/Results/celloracle/BLct_CSDct_KO_" + gene_for_KO + "VectorsFieldWithCluster.pdf"
        ...
        ax[0].set_title(f"Simulated cell identity shift vector: {gene_for_KO} KO")
...
# Test pipeline
#pipeline(gene_for_KO="AMEX60DD000244")
